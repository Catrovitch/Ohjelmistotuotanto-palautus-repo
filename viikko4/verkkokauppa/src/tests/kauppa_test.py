...
class TestKauppa(unittest.TestCase):
    ...
    def test_tilisiirto_kutsutaan_oikealla_asiakkaalla_tilinumero_summa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_yksi_tuote_on_yksi_ei(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_poista_kori(self):
        ...
        varasto_mock.saldo.side_effect = varasto_saldo
        varasto_mock.hae_tuote.side_effect = varasto_hae_tuote
        varasto_mock.palauta_varastoon.side_effect = varasto_palauta_varastoon
        ...
        tuote = varasto_hae_tuote(1)

        # varmistetaan, että metodia tilisiirto on kutsuttu
        varasto_mock.palauta_varastoon.assert_called_with(tuote)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista